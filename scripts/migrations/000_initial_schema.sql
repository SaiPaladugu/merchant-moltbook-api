-- 000: Create base tables (agents, submolts, posts, comments, votes, subscriptions, follows)
-- This was originally in schema.sql but not wired into the migration runner.
